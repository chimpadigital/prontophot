...
<div id="slider-home" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        <?php 
        $i=0;
        while($rows=$slider->fetch_assoc()){
        
        ?>
        <div class="carousel-item <?php if($i==0){ echo ' active ';}?>">
            <img src="<?php echo $rows['imagen'];?>" class="img-slider" alt="...">
            <div class="carousel-caption">
                <div class="align-items-end d-flex flex-column contenedor-caption">
                    <h3 class="font-monument text-bold"><?php echo $rows['titulo'];?></h3>
					<?php if(!empty($rows['subtitulo'])){?><p class="font-monument"><?php echo $rows['subtitulo'];?></p><?php }?>
                    <?php if(!empty($rows['link'])){?>
                    <a class="align-self-center align-self-md-baseline" href="<?php echo $rows['link'];?>">
                    	<button class="btn btn-warning btn-home-amarillo mt-3 "><?php echo $rows['boton'];?></button>
                    </a>
                    <?php }?>
                </div>
            </div>
...
<div id="imprimi-tus-fotos" class="container-fluid py-5 bg-gris-oscuro d-flex flex-column align-items-center banner-imprimi-tus-fotos">
    <div class="row">
        <div class="col-md-4"></div>
        <div class="col-md-6 text-center text-md-left">
            <h3 class="font-monument text-bold text-white">Imprimí tus Fotos</h3>
            <p class="my-4 text-white">Imprimí tus fotos desde la comodidad de tu casa, procesamos tus pedidos con la
                calidad superior de nuestros laboratorios profesionales.</p>
            <a href="revelado_1.php"><button class="btn btn-warning btn-home-amarillo">VER MÁS</button></a>            
        </div>
        <div class="col-md-2"></div>
    </div>
</div>

<div class="destacados-home-1">
    <div class="container py-5 productos-destacados destacados-home">
        <div class="row">
            <div class="col-md-12 mb-3">
                <h3 class="font-monument text-uppercase text-bold">Productos Destacados</h3>
            </div>
            ...
            <div class="col-md-4 d-flex flex-column justify-content-center mb-5">
                <div class="contenedor-card">
                    ...
                    <a href="<?php echo $row['id'].'_'.getUrl($row['nombre']);?>">
                    	<button class="btn bg-danger text-white btn-bg-red w-100">Ver Producto</button>
                    </a>
                </div>
            </div>
			<?php } ?>
            ...
            <div class="col-md-12 d-flex justify-content-center">
                <a href="tienda.php"><button class="btn btn-warning btn-home-amarillo detalles-negros">VER MÁS PRODUCTOS</button></a>                
            </div>
        </div>
    </div>
</div>

<div id="quienes-somos" class="container-fluid pt-5 quienes-somos-seccion">
    <div class="row">
        <div class="col-md-6 quienes-somos-img p-0">
        </div>
        <div class="col-md-6 col-quienes-somos bg-light d-flex flex-column text-left justify-content-center">
            <h3 class="font-monument text-uppercase text-bold">Quiénes Somos</h3>
            <p>Somos una empresa líder en impresión de fotografías y venta de productos relacionados. También contamos
                con la mayor variedad de productos de comunicación e informáticos.</p>
        </div>
    </div>
</div>
                ...
                <div class="mb-3">
                    <div class="d-flex flex-row text-white" for="">
                        ...
                        <div>
                            ...
                            <span class="d-block">Calle 50 entre 8 y 9, Pasaje 8 bis</span>
                            <span class="d-block">WhatsApp 2214385909</span>
                        </div>
                    </div>
                </div>
                <div class="">
                    <div class="d-flex flex-row text-white" for="">
                        ...
                        <div>
                            <p class="d-inline-block text-bold m-0">Sucursal 3</p>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="d-block d-md-flex text-center text-md-left flex-row align-items-center">
                    <a href="index.php"><img src="assets/img/logo-pronto-white.svg" alt=""></a>
			...
			$.ajax({
				...
				success: function(data){
					...
					if (data.success){
						...
						setTimeout(function(){ $('#respuesta').html('')},4000);
...
if (isset($_GET['code'])) {?>
    <script>
		$(function(){
			$('#act-code').val('<?php echo $_GET['code']?>');
			$('#modal-actualizar-contraseña').modal();
		});
    </script>
<?php } ?>
</body>
