...
$query="INSERT INTO `productos`(`id_categoria`, `nombre`, `codigo`, `ancho`, `alto`,  `peso`, `profundidad`, `descripcion`, `stock`, `descuento`, `descuento_final`, `precio`, `color_rojo`, `color_naranja`, `color_azul`, `color_celeste`, `color_violeta`, `color_verde`, `color_amarillo`, `video`, `estado`) VALUES ('$categoria','$nombre','$codigo','$ancho','$alto', '$peso', '$profundidad','$descripcion','$stock','$descuento','$descuento_final','$precio','$rojo','$naranja','$azul','$celeste','$violeta','$verde','$amarillo','$video','0')";
