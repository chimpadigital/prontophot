...
if (isset($_GET['payment_id'])) {
    ...
    if ($_GET['status']=='approved') {
        ...
        echo '<script>window.location.replace("usuario/index.php");</script>';
    }
}elseif ($_GET['pedido']){
    unset($_SESSION['prontoFront']['envio']);
    unset($_SESSION['prontoFront']['valor']);
    ...
    $imagenes=$conectar->query("SELECT * FROM pedidos_imagenes WHERE id_pedido='$idpedido'");
    $sql="SELECT p.*,CONCAT(c.nombre,' ',c.apellido) as clientenombre,c.dni clientedni,CONCAT(c.direccion,' ',c.ciudad) as clientedireccion,c.cp clientecp,c.provincia clienteprovincia,c.telefono clientetelefono FROM pedidos p LEFT JOIN clientes c ON p.id_cliente=c.id WHERE p.id='$idpedido'";
    $ped=$conectar->query($sql);
    $pedido=$ped->fetch_assoc();
                ...
                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                    ...
                    <div class="tab-content" id="contenidoTabsAdmin">
                        ...
                        <div class="tab-pane fade show active" id="" role="tabpanel" aria-labelledby="home-tab">
                            <div class="row">
                                <div class="col-md-12 col-steps p4">
                                    <div
                                        class="align-items-center d-flex d-md-none flex-column text-center step-success">
                                    ...
                                    <ul class="steps">
                                        <li class="step step-success">
                                            <div class="step-content">
                                                ...
                                                <span
                                                    class="step-text mt-3 text-bold step-title d-none d-md-block">Elegir
                                                    Fotos</span>
                                            </div>
                                        </li>
                                        <li class="step step-success">
                                            <div class="step-content">
                                                ...
                                                <span
                                                    class="step-text mt-3 step-title text-bold d-none d-md-block">Envío</span>
                                            </div>
                                        </li>
                                        <li class="step step-success">
                                            <div class="step-content">
                                                ...
                                                <span
                                                    class="step-text mt-3 step-title text-bold d-none d-md-block">Pago</span>
                                            </div>
                                        </li>
                                        <li class="step step-success">
                                            <div class="step-content">
                                                ...
                                                <span class="step-text mt-3 step-title text-bold d-none d-md-block">Pedido Finalizado</span>
                                            </div>
                                        </li>
                                    </ul>
                            ...
                            <div class="row mt-5">
                                <div class="col-md-12">
                                    <div class="d-block d-md-flex align-items-center justify-content-center">
                                        <a href="misCompras.php"><button form="formCargaProducto" class="btn btn-warning btn-cargar-producto btn-block" type="submit">Ir a Mis Compras</button></a>
                                    </div>
                                </div>
                            </div>
