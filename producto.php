        ...
        <div class="col-md-12">
            <a href="tienda">
            	<button class="btn pl-0">
            		<svg xmlns="http://www.w3.org/2000/svg" width="8.627" height="15.09" viewBox="0 0 8.627 15.09"> <path id="Icon_ionic-ios-arrow-back" data-name="Icon ionic-ios-arrow-back" d="M13.851,13.736l5.709-5.705a1.078,1.078,0,0,0-1.527-1.523l-6.469,6.464a1.076,1.076,0,0,0-.031,1.487l6.5,6.509a1.078,1.078,0,0,0,1.527-1.523Z" transform="translate(-11.251 -6.194)" fill="#da0000" /></svg>
                </button>
            </a>
        ...
        <div class="col-md-7">
            <div class="shadow-sm">
                <div id="sync1" class="owl-carousel owl-theme">
                	...
                	while($rowi=$imagenes->fetch_assoc()){?>
                    <div class="item">
                        <img class="img-fluid mt-0" src="<?php echo $rowi['imagen'];?>" alt="">
                    </div>
                    <?php } ?>
                </div>
            </div>
        ...
        <div class="col-md-4">
            <div>
                ...
                <?php if($descuento_porcentaje > 0): ?>
                    <h5 class="titulo-tabs-user m-0" style="text-decoration: line-through; color: #999;">$ <?php echo number_format($precioLista, 2); ?></h5>
                    <h5 class="titulo-tabs-user m-0">$ <?php echo number_format($precioFinal, 2); ?></h5>
                <?php else: ?>
                ...
                <div class="my-2">
                    <button type="button" class="btn btn-link p-0 text-primary" data-toggle="modal" data-target="#cuotasModal">
