...
$(function(){
	...
	$('.btn-pagar').click(function(e){
		...
		{	return false; }
			...
			var id=$(this).data('id');
			$.post('inc/cambiar_estado.php',{id:id},function(data){
				if(data.success){
					location.reload();
				}
			},'json');
                        ...
                        <form id="formBuscarPedido" class="needs-validation w-100 mt-5 form-carga-producto" novalidate>
                            <div class="form-row">
                                <div class="col-sm-12 col-md-11 d-flex align-items-center"><label class="sr-only" for="buscarPedido"></label>
                                    ...
                                    <button type="submit" class="btn bg-danger text-white btn-bg-red ml-0 ml-lg-4 btn-large">Ver pedido</button></div>
