...
$sql1 = "ALTER TABLE productos ADD COLUMN IF NOT EXISTS descuento_final DECIMAL(5,2) DEFAULT 0 COMMENT 'Porcentaje de descuento final'";
...
$sql2 = "ALTER TABLE productos ADD COLUMN IF NOT EXISTS video VARCHAR(200) DEFAULT NULL COMMENT 'URL del video del producto'";
