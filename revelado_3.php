...
if (isset($_POST['tipoenvio'])) {
    ...
    foreach ($tama as $tam=>$cant){
        $query="SELECT * FROM `impresiones` WHERE formato='$tam' AND desde<='$cant' AND hasta>='$cant' ORDER BY fecha DESC LIMIT 1";
    ...
    <div class="row">
        <div class="col-md-12 steps-home">
            <div class="align-items-center d-flex d-md-none flex-column text-center mt-5 mt-md-0">
                <svg id="paso-3" xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 33 30.236">
