...
ADD COLUMN factura_a TINYINT DEFAULT NULL COMMENT 'si contiene factura A'";
...
$sql = "ALTER TABLE pedidos 
ADD COLUMN cuit VARCHAR(100) DEFAULT NULL COMMENT 'cuit del cliente'";
if ($conectar->query($sql) === TRUE) {
...
$sql = "ALTER TABLE pedidos 
ADD COLUMN razon_social VARCHAR(100) DEFAULT NULL COMMENT 'razon social del cliente'";
if ($conectar->query($sql) === TRUE) {
