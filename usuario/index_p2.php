                ...
                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                    ...
                    <div class="tab-content" id="contenidoTabsAdmin">
                        ...
                        <div class="tab-pane fade show active" id="" role="tabpanel" aria-labelledby="home-tab">
                            <div class="row">
                                <div class="col-md-12 col-steps p2">
							...
							<form class="form-rosa " method="post" action="index_p3.php">
                            <!-- FORM METODO ENVIO -->
                            <div class="row shadow-sm p-3 metodo-envio">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input retiroSucursal" type="radio" name="tipoenvio" id="sucursal3" value="suc3">
                                        <label class="form-check-label d-flex flex-row" for="sucursal3">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                                class="bi bi-geo-alt-fill text-danger mt-1 mr-1 mr-md-2" viewBox="0 0 16 16">
                                                <path
                                                    d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z" />
                            ...
                            <div>
                                <div id='collapsediv1' class="row metodo-envio collapse in">
                                    ...
                                    <div class="col-12 col-md-6 shadow-sm p-3 w-100">
                                        <div class="form-check  d-block align-items-baseline">
                                    ...
                                    <div class="col-12 col-md-6 shadow-sm p-3 ">
                            ...
                            <div class="row mt-5">
                                <div class="col-md-12 p-md-0">
                                    <div class="d-block d-md-flex align-items-center justify-content-center my-3">
                                        <a href="index.php"><button class="btn btn-border-yellow text-black btn-block">Atras</button></a>
