                            	...
                            	<div class="col-12 col-sm-8">
                            		...
                            		while ($rowi=$imagenes->fetch_assoc()) { ?>
                            			<div class="col-sm-6 text-center divImagen" id="imagen<?php echo $i;?>">
                                            ...
                                            <span class="d-block my-3">Tamaño de imagen 1366x609px</span>
